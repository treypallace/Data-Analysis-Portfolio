...
data_dir<-"https://raw.githubusercontent.com/treypallace/STAT-3280-Final-Project/main/"
...
rent<-read.csv(paste0(data_dir,"medianrent.csv"))
...
myrent<-read.csv(paste0(data_dir,"myrent.csv"))
...
tuition<-read.csv(paste0(data_dir,"tuition.csv"))
...
######################## Plot 3 ##################################
hpi_master<-read.csv(paste0(data_dir,"HPI_master.csv"))
...
income<-read.csv(paste0(data_dir,"income_distribution.csv"))
...
########################## Plot 5 ######################################
spdf <- geojson_read(paste0(data_dir,"charlottesville-sc_.geojson"),  what = "sp")
